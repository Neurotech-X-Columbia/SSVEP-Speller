...
cwd = os.getcwd()
sesname = "session_01-07-24_934275"
dpath = os.path.join(os.getcwd(), "Data", "NewCombs", sesname, "data.csv")
...
plt.figure()
plt.subplot(3, 1, 1)
plt.plot(tstart + tvec, filtavgtrunc, linewidth='0.5')
plt.grid()
...
plt.subplot(3, 1, 2)
plt.plot(Fs / L * np.arange(-L / 2, L / 2), np.abs(norm_shift), linewidth='0.5')
plt.grid()
...
plt.subplot(3, 1, 3)
plt.plot(freq, 10 * np.log10(psdx), linewidth='0.5')
plt.grid()
